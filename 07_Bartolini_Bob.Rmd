...
crossing(Mean = seq(162.71, 262.71, by = 100), 
...
Flip_dist <- crossing(Mean = seq(162.71, 262.71, by = 100), 
                      SD =seq(200, 220, by = 0.2)) %>%
  rowwise() %>%
...
https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE136823<br>
I expect this to be differentially expressed </span>
